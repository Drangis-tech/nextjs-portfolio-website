...
const PricingCalculator: React.FC = () => {
  ...
  return (
    <Card className="bg-transparent border border-zinc-700 shadow-none rounded-lg p-6 md:p-10">
      <article className="relative w-full h-full p-6 md:p-10 bg-[rgba(28, 28, 30, 0.8)] rounded-lg backdrop-blur-sm">
        <h3 className="text-3xl font-semibold tracking-tight text-zinc-100 sm:text-4xl mb-8">
        ...
        <div className="mb-6">
          <label htmlFor="design" className="block text-sm font-medium text-zinc-100 mb-2">
        ...
        <div className="mb-6">
          <label htmlFor="websiteType" className="block text-sm font-medium text-zinc-100 mb-2">
            Svetainės tipas:
          </label>
          <select
            id="websiteType"
        ...
        <div className="mb-6">
          <label htmlFor="comments" className="block text-sm font-medium text-zinc-100 mb-2">
        ...
        <div className="text-xl font-semibold text-zinc-100 mb-8">
