...
const KainosPage: React.FC = () => {
  ...
  return (
    <div className="relative pb-16 bg-gradient-to-b from-black via-zinc-900 to-black">
      ...
      <div className={`fixed inset-0 backdrop-blur-sm transition-opacity duration-300 ease-in-out ${isMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}></div>
