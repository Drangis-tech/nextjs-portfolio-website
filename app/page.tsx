...
export default function Home() {
  useEffect(() => {
    ...
    // Insert the JavaScript code for the canvas animation
  ...
  return (
    <div id="container" className="relative flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-black">
      ...
      <div className="flex flex-col items-center justify-center z-10">
        <div className="flex flex-col items-center">
          ...
          />
          <h1
            className="title text-4xl text-transparent bg-white bg-clip-text duration-1000 cursor-default text-edge-outline animate-title font-display sm:text-6xl md:text-9xl whitespace-nowrap"
      ...
      <div className="my-16 text-center animate-fade-in">
        <h2 className="description text-sm text-zinc-500 shine-effect">
          Mes padedame verslams augti naudojant inovatyvius IT sprendimus.
        </h2>
      </div>

      {/* Example hexagon container (adjust as needed) */}
