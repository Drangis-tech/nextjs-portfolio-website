...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex flex-col w-screen overflow-hidden bg-black">
        ...
        <div className="flex flex-col flex-1">
          ...
          {/* Cards Section */}
          <div className="w-full flex flex-col md:flex-row justify-center px-4 md:px-8 gap-4 md:gap-8 mb-8 z-20" style={{ flex: '0 0 auto' }}>
