...
const SvgBackground: React.FC<SvgBackgroundProps> = ({ cursorPos }) => {
  ...
  const generateDots = () => {
    ...
    if (windowSize.width && windowSize.height) {
      // Extend width to 2 times and height to 5 times to ensure full coverage
      const extendedWidth = windowSize.width * 2; 
      const extendedHeight = windowSize.height * 5; 
  ...
  return (
    <svg
      ...
      viewBox={`0 0 ${windowSize.width * 2} ${windowSize.height * 5}`} // Extend viewBox width and height
